// This script takes a pdf file and repeats the page over the document in a grid.
//If you want to change this to your own values, you can change the preset document sizes, the units, and the distance between the repeats. I added comments where things need changing.
...
{  
    ...
    {  
        ...
        function ExportPDF()
        {
            //Change auto-export directory here
            app.activeDocument.exportFile(ExportFormat.pdfType, File("/Users/admin/Desktop/BestFit/"+theFile.name+nameAddition + "_" + ind + ".pdf"), false);
